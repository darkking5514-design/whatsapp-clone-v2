...
import { Plus, X, Download, Trash2, Eye, Camera, Type, Video, Send } from 'lucide-react';
...
export default function Status() {
  ...
  // CREATE TEXT STATUS
  // ============================================
  async function createTextStatus(e) {
    e.preventDefault();
  ...
  // ============================================
  // UPLOAD MEDIA STATUS (Image/Video + Text)
  // ============================================
  async function uploadMediaStatus(e) {
    e.preventDefault();
  ...
  // ============================================
  // CHECK IF STATUS IS MINE
  // ============================================
  function isMyStatus(status) {
    return status.userId?._id === user?.id || status.userId === user?.id;
  }

  // ============================================
  // GET VIEW COUNT
  // ============================================
  function getViewCount(status) {
    return status.viewedBy?.length || 0;
  }
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          {!loading && statuses.length === 0 && (
            <p className="text-gray-400 text-center mt-6">
              No active statuses. Statuses disappear after 24 hours.
            </p>
          )}
              ...
              <div key={userInfo._id || Math.random()} className="px-4 py-2 border-b border-black/10">
                ...
                <div className="flex gap-2 overflow-x-auto pb-2">
                  {userStatuses.map((s) => {
                    ...
                    const viewCount = getViewCount(s);
                    ...
                    return (
                      ...
                      >
                        ...
                        {!isMine && viewCount > 0 && (
                          <span className="absolute -top-1 -right-1 bg-whatsapp-green text-black text-[10px] font-bold rounded-full w-5 h-5 flex items-center justify-center">
                            {viewCount}
                          </span>
                        )}
                      </button>
            ...
            <div className="flex justify-center gap-4 mt-4">
              ...
              {!isMyStatus(viewing) && (
                <div className="flex items-center gap-2 text-gray-400 text-sm">
                  <Eye size={16} />
                  <span>{getViewCount(viewing)} views</span>
                </div>
              )}
            </div>
          </div>
